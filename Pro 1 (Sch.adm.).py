...
def write_into_csv(info_list):
    with open('student_info.csv', 'a', newline=' ') as csv_file:
        ...
        if csv_file.tell() == 0:
            writer.writerow(["Name", "Roll No.", "Contact number" "Email ID"])
...
if __name__ == '__main__':
    ...
    while(condition):
        student_info = input("Enter student information for student #{} in the format (Name Roll No. Contact number Email ID):")
